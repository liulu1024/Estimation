...
for point in [5,8,10]:
    ...
    with_noise = True
    noise = 'noise' if with_noise else 'no_noise'
    data_filename='data/fn/{}/{}/test/{}.csv'.format(point,noise,'data')
    time_filename='data/fn/{}/{}/test/{}.csv'.format(point,noise,'time')
    param_filename='data/fn/{}/{}/test/{}.csv'.format(point,noise,'param')
